    ...
    <div class="row">
        <table class="small-12 columns items">
            <tr>
                <td>
                    <h3>
                        ...
                        <small class="website"></small><a href="">Meteora.com</a>
                        <a href="" class="right"><small class="remove"></small> </a>
                    </h3>
            ...
            <tr>
                <td>
                    <h3>
                        <small class="hosting"></small><a href="">Web Hosting Package</a>
                        <a href="" class="right "><small class="remove"></small> </a>
                    </h3>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <h3>
                        <small class="website"></small><a href="">Veronica.com</a>
                        <a href="" class="right"><small class="remove"></small> </a>
                    </h3>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <h3>
                        <small class="email"></small><a href="">Email Hosting Package</a>
                        <a href="" class="right "><small class="remove"></small> </a>
                    </h3>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <h3>
                        <small class="design"></small><a href="">Web Design Package</a>
                        <a href="" class="right "><small class="remove"></small> </a>
                    </h3>
                </td>
                <td>
...
<!--        Payment-->
        ...
        <div class="large-4 columns ">
            ...
            <div class="row">
                ...
                <a class="large-12 columns button large hide-for-medium-down proceedPayment text-center" href="" data-reveal-id="payment">
                    Proceed to Payment
                    <small></small>
                </a>
            </div>
            ...
            <div class="small-10 columns small-centered">
                ...
                <div class="row">
                    ...
                    <div class="large-6 medium-12 columns large-pull-6">
                        <button type="submit" value="Proceed" id="proceed" class="button large-11 columns text-center proceedPayment">
                            Proceed
                            <small></small>
                        </button>
                    </div>
